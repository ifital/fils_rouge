...
<body class="bg-gray-100">
    ...
    <!-- Header Navigation (Reused from previous example) -->
            ...
            <div class="flex flex-col md:flex-row items-center gap-8 lg:gap-12">
                ...
                <div class="w-full md:w-1/2 order-2 md:order-1 bg-gray-50 p-6 lg:p-8 rounded-lg shadow-sm">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between">
                        ...
                        <a href="#" class="inline-block bg-yellow-400 text-black px-4 py-2 rounded-full font-semibold text-xs hover:bg-yellow-500 transition duration-200 whitespace-nowrap">
                            reserve now
                        </a>
                    </div>
                </div>
    ...
    <footer class="bg-gray-200 text-gray-700 mt-16 pt-12 pb-8">
        <div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <a href="mailto:bluewaves777@gmail.com" class="text-sm hover:text-black hover:underline">bluewaves777@gmail.com</a>
            ...
            <div>
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="#" aria-label="Facebook" class="text-gray-600 hover:text-black">
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"> <!-- Replace with actual icon -->
                     ...
                     <!-- Add other icons (Twitter, LinkedIn, etc.) -->
                </div>
            </div>
        </div>
         <!-- Copyright or other info if needed -->
