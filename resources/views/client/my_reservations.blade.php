                        ...
                        <div class="flex flex-row sm:flex-col gap-4 sm:gap-0 w-full sm:w-auto justify-between">
                            <!-- Dates -->
                             <div class="text-sm mb-2">
                                 <p class="font-medium text-gray-700">check in <span class="text-blue-600 font-semibold">24/5/2025</span></p>
                                 <p class="font-medium text-gray-700">check out <span class="text-blue-600 font-semibold">24/5/2025</span></p>
                             </div>
                             <!-- Price & Occupancy -->
                             <div class="text-right sm:text-left">
                                 <p class="text-3xl font-bold text-gray-900">€25</p>
                                 <p class="text-sm text-gray-700 font-medium">2 adults / <span class="text-gray-400 font-normal">1 night</span></p>
                             </div>
                        </div>
