...
<head>
    ...
    <!-- Include Tailwind CSS via Play CDN (for development/testing) -->
    <script src="https://cdn.tailwindcss.com"></script>
    <!-- Include Alpine.js via CDN (for mobile menu toggle) -->
    <script defer src="https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js"></script>
    <style>
        /* Optional: Add custom base styles or fonts here if needed */
        /* Example: @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap'); */
        /* body { font-family: 'Poppins', sans-serif; } */

        /* Helper class for hero section background */
        .hero-bg-image {
