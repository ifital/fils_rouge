        ...
        <aside id="sidebar"
            ...
            <nav class="py-4">
                <ul class="space-y-1">
                    ...
                    {{-- Add other relevant links for the employee role --}}
                    <li>
                        <a href="" class="flex items-center px-4 py-3 text-yellow-400 bg-gray-900 border-l-4 border-yellow-400"> {{-- Assuming this route exists and is the current page --}}
                            <span class="sidebar-icon mr-3"><i class="fas fa-calendar-alt"></i></span>
                            <span>Activity Reservations</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center px-4 py-3 text-white hover:bg-gray-800 hover:text-yellow-400">
                            <span class="sidebar-icon mr-3"><i class="fas fa-users"></i></span>
                            <span>Customers</span> {{-- Example Link --}}
                        </a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center px-4 py-3 text-white hover:bg-gray-800 hover:text-yellow-400">
                            <span class="sidebar-icon mr-3"><i class="fas fa-cog"></i></span>
                            <span>Settings</span>
                        </a>
                    </li>
                </ul>
            ...
            <!-- Logout Button -->
            <div class="p-4 border-t border-gray-800 mt-auto"> {{-- Added mt-auto to push to bottom --}}
                <a href="#" {{-- Replace with actual logout route --}} class="flex items-center text-gray-400 hover:text-yellow-400">
                    <span class="sidebar-icon mr-3"><i class="fas fa-sign-out-alt"></i></span>
                    <span>Logout</span>
                </a>
            </div>
        </aside>
